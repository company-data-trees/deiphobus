...
var {ConsistencyLevel, ColumnParent, ColumnOrSuperColumn, Column, CounterColumn, Mutation}
...
Mutator.prototype.put = function(column_family, key, columns, options) {
    ...
    columns.forEach(function(column) {
        ...
        if (type === 'CounterColumnType') {
            var c = new CounterColumn();
            csc.setCounter_column(c);
        } else {
            var c = new Column();
            csc.setColumn(c);
