...
// helper methods for dealing with data lacking a proper default type.
ByteArray.prototype.asByteBuffer = function() {
    return Marshal.BytesType.to(this);
}

ByteArray.prototype.as = function(type) {
    return Marshal.for(type).from(this.asByteBuffer());
}

// a helper helper for the common case
ByteArray.prototype.asString = function() {
    return this.as('UTF8Type');
}
